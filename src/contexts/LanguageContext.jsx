  ...
  const translations = {
    he: {
      ...
      about: {
        ...
        text1:
          'כבוגרת מסלול הנדסאי אדריכלות ועיצוב פנים בשנקר הנדסאים, אני משלבת בין דיוק טכני לראייה עיצובית מוקפדת, מתוך שאיפה ליצור חללים שמרגישים נכון - גם פונקציונלית וגם אסתטית.',
        text2:
